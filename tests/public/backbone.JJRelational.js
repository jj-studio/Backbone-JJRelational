...
(function() {
  "use strict";
  var Backbone, exports, flatten, getUrlForIdQueue, getUrlForModelWithId, getValue, isManyType, isOneType, urlError, wrapError, _;
  ...
  Backbone.JJRelationalModel = Backbone.Model.extend({
    ...
    */
    ...
    set: function(key, val, options) {
      var attrs, change, changes, changing, current, prev, relation, silent, unset, v, value, _i, _j, _len, _len1;
      if (key === null) {
        return this;
      }
