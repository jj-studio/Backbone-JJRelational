...
var A, Author, AuthorsColl, B, Book, BooksColl, Literature, Publisher, PublishersColl, assert, expect, should;
...
describe('Testing setting/adding/removing from relations', function() {
  ...
  it('Adding a wife ID to Orwell should sync', function() {
    var w;
    w = new Literature.Wife({
...
describe('Deep relations (almost true love) and smart update', function() {
  ...
  it('Martin should have relations to books with ids 20, 21, 22', function() {
    var book, i, id, len, martin, ref, results;
    ...
    for (i = 0, len = ref.length; i < len; i++) {
      ...
      results.push(book.get('author').should.equal(martin));
    }
    return results;
  });
  ...
  it('Martin should have relations to books with ids 20, 22, 23, 24 and 25 in idQueue', function() {
    var book, clash, game, i, id, len, martin, ref;
    clash = new Book({
      id: 23,
